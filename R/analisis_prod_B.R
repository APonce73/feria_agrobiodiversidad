...
gt2 <- gridExtra::grid.arrange(gt1, bottom = "Promedio de campesinos (2016 al 2019)\nque llevaron o adquirieron productos")

#((Fig1 + Fig2) / (Fig3 + Fig4))
ggsave(plot = gt2 ,"figuras/Figura2.jpeg", width = 10, height = 9, device = "jpeg", dpi = 500)
...
gt <- plotF1 + plotF2 + plotF3 + plotF4 +
    plot_layout(ncol = 4)

gt1 <- patchwork::patchworkGrob(gt)
gt2 <- gridExtra::grid.arrange(gt1, bottom = "Promedio de campesinos que adquirieron (1), sembraron (2), crecieron (3) y \n sembraron nuevamente (4)")

#((Fig1 + Fig2) / (Fig3 + Fig4))
ggsave(plot = gt2 ,"figuras/Figura3.jpeg", width = 11, height = 6.5, device = "jpeg", dpi = 500)
